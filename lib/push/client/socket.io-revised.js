...
Socket.prototype.onClose = function (reason, desc) {
  if ('opening' == this.readyState || 'open' == this.readyState) {
    ...
    //FIXME by tony at 2014/6/5, 解决服务器关闭时的IE6内存溢出问题 begin
    setTimeout(function() {
      self.writeBuffer = [];
      self.callbackBuffer = [];
      self.prevBufferLen = 0;
    }, 0);
      //FIXME by tony at 2014/6/5, 解决服务器关闭时的IE6内存溢出问题 end
...
exports.encodePayload = function (packets, supportsBinary, callback) {
  ...
  //alert('map--before:' + packets[0].type);
