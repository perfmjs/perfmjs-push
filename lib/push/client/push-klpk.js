 ...
 */
define('klpkPushClient', ['utils', 'base', 'pushClient'], function(utils, base, pushClient) {
    ...
    base.klpkPushClient.defaults = {
        socketURL: 'http://push.no100.com/klpk',
        path: '/klpk/socket.io',
        end: 0
    };
    return base.klpkPushClient;
});