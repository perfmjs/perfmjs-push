!function(e){"object"==typeof exports?module.exports=e():"function"==typeof define&&define.amd1?define(e):"undefined"!=typeof window?window.io=e():"undefined"!=typeof global?global.io=e():"undefined"!=typeof self&&(self.io=e())}(function(){var define,module,exports;
...
Socket.prototype.onClose = function (reason, desc) {
  if ('opening' == this.readyState || 'open' == this.readyState) {
    ...
    //FIXME by tony at 2014/6/20, 解决服务器关闭后的IE6内存溢出问题,下面的setTimeout可以不注释 begin
//    setTimeout(function() {
//      self.writeBuffer = [];
//      self.callbackBuffer = [];
...
//    }, 0);
      setTimeout(function() {
          ...
          self.callbackBuffer.length = 0;
          self.prevBufferLen = 0;
      }, 0);
    //FIXME by tony at 2014/6/20, 解决服务器关闭后的IE6内存溢出问题,下面的setTimeout可以不注释 end
...
Request.prototype.create = function(isBinary, supportsBinary){
  ...
  var self = this;
    //FIXME add by tony at 2014/6/20, 设置xhr timeout begin
...
Polling.prototype.doClose = function(){
  ...
  if ('open' == this.readyState) {
    ...
    //FIXME by tony at 2014/6/20, 解决服务器关闭后的IE6内存溢出问题 begin
    this.readyState = 'closed';
    //FIXME by tony at 2014/6/20, 解决服务器关闭后的IE6内存溢出问题 end
    close();
  } else {
...
;
//FIXME by tony at 2014/8/14, 将模块化标识define.amd改为define.amd1-begin
define('socket.io-client', function(require) {
    return io;
});
//FIXME by tony at 2014/8/14, 将模块化标识define.amd改为define.amd1-end
/**
...
define('pushClient', ['base', 'socket.io-client'], function(base, io) {
    base("pushClient", {
        ...
        /**
         * 打开socket连接
         * @param url，e.g. 'http://nodejs.no100.com/kc'
        ...
        _openSocketConnect: function(url, path) {
            ...
            var socketConn = ((typeof module !== 'undefined' && module.exports)?require('socket.io-client'):io).connect(url, {
                'path': path,
                'forceNew': true,
...
//                'reconnectionAttempts': 200, //最多重连200次
                'timeout': 10000
            });
         ...
         * dataType maybe: 'kc'|'ssq'|'jc'
         * @param options, e.g. {'version':$$.utils.now().toString(),'dataType':'kc','result':{}}
         * @returns {*}
         * @private
         */
