 ...
 */
!(function() {
	perfmjs.includeres.loadModules({name:'push-comm', type:'js', mdCallback:function(source, module, combineUrls) {
		//按模块加载资源文件
		if (module === 'push') {
            ...
            combineUrls[combineUrls.length] = 'http://nodeclient.no100.com/push-xysc.js';
